...
<div class="wrapper">
	<div class="fluid">
		<div class="widget">
			<?php $atr = array('name' => 'frm', 'id' => 'frm'); echo form_open('invoicesupplier/save',$atr); ?>
			...
			<label for="id_ro"><input type="hidden" name="id_ro" value="<?=$id_ro?>"></label>
				...
				<div class="formRow">
					...
					<input type="submit" name="simpan" id="simpan" value="Simpan Invoice" class="buttonM bBlue" />
					<input type="button" name="Kembali" id="Kembali" value="Kembali" class="buttonM bBlue" onclick="parent.location='<?=base_url();?>invoicesupplier'" />
					 </div>
					<div class="clear"></div>
				</div>
			<?php echo form_close(); ?>
