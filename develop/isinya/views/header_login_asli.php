...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=base_url()?>bootstrap/css/login.css" media="screen" />
...
<script type="text/javascript" src="<?=base_url()?>asset/js/files/functions.js"></script>
	...
	<script type="text/javascript" src="<?=base_url()?>asset/js/plugins/wizards/jquery.validate.js"></script>
	<script type="text/javascript" src="<?=base_url()?>asset/js/files/login.js"></script>
	<script type="text/javascript" >
		$(document).ready(function() {
			...
			$("#lingNew").click(function () { 
      		$('#formLogin').fadeOut(1000, function() {
   				$('#formRegister').fadeIn(1000);
  				});
  				
    		});
    		
    		$("#lingLogin").click(function () { 
      		$('#formRegister').fadeOut(1000, function() {
