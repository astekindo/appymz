...
<div class="wrapper">
	<div class="fluid">
		...
		<?php 
			...
			echo form_open('retur_order/addcart',$atr); 
		?>
            ...
            <div class="whead"><h6>Data - Master Produk </h6>
						<select data-placeholder="Cari nama produk..." class="chzn-select" style="float: right;margin-top:30px;margin-right:50px;width:100px;" tabindex="1" name="kd_produk" id="kd_produk">
							<option value=""></option> 
  								<?php
									foreach($tm_produk_retur->result_array() as $db)
									{
								?>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="tDefault">
				...
				<tbody>
					<tr>
						<div id="data_produk_retur" class="formRow"></div>
					</tr>
					<tr>
					<td colspan="2"><input type="submit" name="addcart" id="addcart" value="Tambah" class="buttonM bRed" /></td>
					</tr>
                </tbody>
            </table>
			<?php echo form_close(); ?>
					...
					<script type="text/javascript"> 
						...
						$.ajax({ 
						url: "<?php echo base_url(); ?>retur_order/ambil_data_produk",
						data: "kd_produk="+kd_produk, 
						cache: false, 
						success: function(msg){ 
						$("#data_produk_retur").html(msg);
