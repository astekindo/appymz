...
<div class="wrapper">
	<div class="widget">
		<div class="whead"><h6>Detail Produk - Lokasi : <? echo $nama_lokasi ?> - <? echo $nama_blok ?> - <? echo $nama_sub_blok ?> </h6><div class="clear"></div></div>
            <div class="shownpars">
				...
				<tbody> 
					...
					<tr class="content">
						...
						<td class="td-keranjang" align="right"><?php echo $items['qty_in']; ?> </td>
						<td class="td-keranjang" align="right"><?php echo $items['qty_out']; ?> </td>
