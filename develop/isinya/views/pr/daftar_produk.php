...
<div class="wrapper">
	<div class="fluid">
		...
		<?php 
			...
			echo form_open('purchaserequest/addcart',$atr); 
		?>
			...
			<?php echo form_close(); ?>
					...
					<script type="text/javascript"> 
								...
								$.ajax({ 
								url: "<?php echo base_url(); ?>purchaserequest/daftar_Produk_onchange",
								...
								var kd_produk = $("#kd_produk").val(); 
								$.ajax({ 
								url: "<?php echo base_url(); ?>purchaserequest/ambil_data_produk",
								data: "kd_produk="+kd_produk, 
								cache: false, 
								success: function(msg){ 
