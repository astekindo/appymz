		...
		<div class="widget grid8">
			...
			<?php $atr = array('name' => 'fkategori', 'id' => 'fkategori'); echo form_open('purchaserequest/savepr',$atr); ?>
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid9">
                            <span class="grid6">
							<input type="text" id="subject" name="subject" value="<?=$subject?>" style="width:350px;" class="required" /></span>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow">
			...
			<div class="formRow">
                    <div class="whead"><h6>LIST PRODUK</h6><div class="clear"></div>
						...
						<input type="button" style="float: right;margin-top:-33px;margin-right:5px;" name="Kembali" id="Kembali" value="Kembali" class="buttonM bBlue" onclick="parent.location='<?=base_url();?>purchaserequest'" />
                    </div>
