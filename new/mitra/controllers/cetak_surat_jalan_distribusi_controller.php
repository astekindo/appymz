 ...
 * @author Yakub
 */
class cetak_surat_jalan_distribusi_controller extends MY_Controller {
    ...
    function __construct() {
        parent::__construct();
        $this->load->model('cetak_surat_jalan_distribusi_model');
    ...
    public function finalGetDataSJDist() {
        echo $this->cetak_surat_jalan_distribusi_model->getDataSuratJalanDist($this->limit, $this->offset, $this->search, $this->tanggalAwal, $this->tanggalAkhir);
    }

    public function finalGetDataSJDistDetail() {
        echo $this->cetak_surat_jalan_distribusi_model->getDataSuratJalanDistDetail($this->limit, $this->offset, $this->noSJ, $this->search);
    }
