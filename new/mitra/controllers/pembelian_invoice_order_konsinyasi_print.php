...
class pembelian_invoice_order_konsinyasi_print extends MY_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('pembelian_invoice_order_print_konsinyasi_model', 'piopk_model');
    }
    ...
    public function get_rows() {
        ...
        $result = $this->piopk_model->get_rows($kd_supplier, $kd_peruntukan, $search, $start, $limit);
