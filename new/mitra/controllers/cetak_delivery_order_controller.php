 ...
 * @author Yakub
 */
class cetak_delivery_order_controller extends MY_Controller {
    ...
    function __construct() {
        parent::__construct();
        $this->load->model('cetak_delivery_order_model');
    ...
    public function finalGetDataDO() {
        echo $this->cetak_delivery_order_model->getDataDeliveryOrder($this->limit, $this->offset, $this->search, $this->tanggalAwal, $this->tanggalAkhir);
    }

    public function finalGetDataDODetail() {
        echo $this->cetak_delivery_order_model->getDataDeliveryOrderDetail($this->limit, $this->offset, $this->noDo, $this->search);
    }
