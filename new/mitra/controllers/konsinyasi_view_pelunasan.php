...
class Konsinyasi_view_pelunasan extends MY_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('konsinyasi_view_pelunasan_model');
    }
    ...
    public function search_nobukti() {
        ...
        $result = $this->konsinyasi_view_pelunasan_model->search_nobukti($kd_peruntukan,$search, $start, $limit);
