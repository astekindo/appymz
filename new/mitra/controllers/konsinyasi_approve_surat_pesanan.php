...
class Konsinyasi_approve_surat_pesanan extends MY_Controller {
    ...
    public function __construct() {
        parent::__construct();
		$this->load->model('konsinyasi_approve_surat_pesanan_model');
    }
	...
	public function get_rows_detail($no_po=''){
		...
		$limit = isset($_POST['limit']) ? $this->db->escape_str($this->input->post('limit',TRUE)) : $this->config->item("length_records");
                ...
                $hasil = $this->konsinyasi_approve_surat_pesanan_model->get_rows_detail($no_po, $start, $limit);
		$results = array();
	...
	public function get_rows(){
        ...
        $result = $this->konsinyasi_approve_surat_pesanan_model->get_rows($search, $start, $limit);
	...
	public function update_row(){
		...
		if ($this->konsinyasi_approve_surat_pesanan_model->update_row($no_sp, $datau)) {
