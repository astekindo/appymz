...
class Approval_manager extends MY_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('approval_manager_model');
    }
    ...
    public function get_rows() {
        ...
        $result = $this->approval_manager_model->get_rows($kd_peruntukan,$search, $start, $limit);

        echo $result;
    }

    public function get_rows_detail($no_ro = '') {
        $result = $this->approval_manager_model->get_rows_detail($no_ro);
    ...
    public function update_row() {
        ...
        $this->db->trans_begin();
        $this->approval_manager_model->update_row($no_ro, $datau);
        ...
        foreach ($detail as $obj) {
            ...
            if ($obj->qty_adj != $obj->qty && $keterangan2 == '') {
                ...
                if (!$this->approval_manager_model->update_row_detail($no_ro_det, $kd_prod_det, $detail_app)) {
    ...
    public function update_row_detail() {
        ...
        $this->db->trans_begin();
        $this->approval_manager_model->update_row($no_ro_det, $datax);
        ...
        if ($qty_adj != $qty && $keterangan2 == '') {
            ...
            if ($this->approval_manager_model->update_row_detail($no_ro_det, $kd_prod_det, $datau)) {
