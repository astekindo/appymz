...
class Laporan_penjualan3 extends MY_Controller {
	/**
	 * @author dhamarsu
	 * @editedby luxse
    ...
    public function __construct() {
        parent::__construct();
		$this->load->model('laporan_penjualan3_model');
    }
	...
	public function print_form($kd_user = '',$kd_shift = '',$kd_member = '',$dari_tgl = '',$sampai_tgl = ''){
		$data = $this->laporan_penjualan3_model->get_data_penjualan3_print($kd_user,$kd_shift,$kd_member,$dari_tgl,$sampai_tgl);
		if(!$data) show_404('page');
		
		$this->output->set_content_type("application/pdf");
		require_once(APPPATH . 'libraries/LaporanPenjualan3Print.php');
		$pdf = new LaporanPenjualan3Print(PDF_PAGE_ORIENTATION_LANDSCAPE, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		$pdf->setKertas();
