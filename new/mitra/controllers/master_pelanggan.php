...
class Master_pelanggan extends MY_Controller {
    ...
    public function get_sales() {
        $result = $this->master_pelanggan_model->get_sales();
        echo $result;
    }

    public function getArea() {
        $result = $this->master_pelanggan_model->getArea();
        echo $result;
    }
    ...
    public function update_row() {
        ...
        $area = isset($_POST['kd_area']) ? $this->db->escape_str($this->input->post('kd_area', TRUE)) : FALSE;
        ...
        $tipe_pelanggan = isset($_POST['tipe']) ? $this->db->escape_str($this->input->post('tipe', TRUE)) : FALSE;
        ...
        $no_fax = isset($_POST['no_fax']) ? $this->db->escape_str($this->input->post('no_fax', TRUE)) : FALSE;
        ...
        $is_pkp = isset($_POST['is_pkp']) ? $this->db->escape_str($this->input->post('is_pkp', TRUE)) : FALSE;
        ...
        if (!$kd_pelanggan) { //save
            $data = array(
                ...
                'top_dist' => intval($top_dist),
                'limit_dist' => intval($limit_dist),
                'aktif' => $aktif,
                'no_fax' => $no_fax,
                'email' => $email,
                'kd_kalurahan' => $kd_kalurahan,
                'is_pkp' => $is_pkp,
                'kd_cabang' => $kd_cabang,
                'tipe' => $tipe_pelanggan,
                'kd_area' => $area
