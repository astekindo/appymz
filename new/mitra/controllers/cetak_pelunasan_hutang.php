...
class Cetak_pelunasan_hutang extends MY_Controller {
    ...
    public function get_rows() {
        ...
        $result = $this->cph_model->get_rows($kd_supplier,$kd_peruntukan, $search, $start, $limit);

        echo $result;
    }

    public function get_rows_detail($no_bukti = '') {
        $hasil = $this->cph_model->get_rows_detail($no_bukti);
        $results = array();
