...
class Laporan_kartu_stok extends MY_Controller {
	...
	public function print_form($dari_tgl = '',$sampai_tgl = ''){
		$data = $this->laporan_kartu_stok_model->get_data_print($dari_tgl,$sampai_tgl);
		if(!$data) show_404('page');
		
		$this->output->set_content_type("application/pdf");
		require_once(APPPATH . 'libraries/LaporanKartuStokPrint.php');
		$pdf = new LaporanKartuStokPrint(PDF_PAGE_ORIENTATION_LANDSCAPE, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		$pdf->setKertas();
