...
class Laporan_penjualan_per_kategori1 extends MY_Controller {
    ...
    public function __construct() {
        parent::__construct();
		$this->load->model('laporan_penjualan_per_kategori1_model');
    }
	 ...
	 */
	public function print_form($kd_user = '',$kd_shift = '',$dari_tgl = '',$sampai_tgl = ''){
		
               $data = $this->laporan_penjualan_per_kategori1_model->get_penjualan_perkategori1_print($kd_user,$kd_shift,$dari_tgl,$sampai_tgl);
		if(!$data) show_404('page');
		
		$this->output->set_content_type("application/pdf");
		require_once(APPPATH . 'libraries/LaporanPenjualanPerKategori1Print.php');
		$pdf = new LaporanPenjualanPerKategori1Print(PDF_PAGE_ORIENTATION_LANDSCAPE, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
		$pdf->setKertas();
