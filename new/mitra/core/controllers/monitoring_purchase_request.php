...
class Monitoring_purchase_request extends MY_Controller {
	...
	public function get_data_pr($no_pr = ''){
		...
		foreach($d as $v){
			echo '
				...
				<td align="center" bgcolor="#f5f5f5">'.$v->keterangan1.'</td>	
				</tr>
			';
			$total = $total + $v->qty;
			$no++;
	...
	public function get_rows(){
        ...
        $result = $this->monitoring_pr_model->get_rows($kdSupplier, $tglAwal, $tglAkhir, $status, $close_pr, $konsinyasi, $search, $start, $limit);
