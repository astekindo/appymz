...
class Pricetag_print extends MY_Controller {
    ...
    public function submit() {
        ...
        $produk2 = array('cetak_besar' => $cetak_besar, 'cetak_kecil' => $cetak_kecil, 'nm_satuan' => $nm_satuan2,'kd_produk' => $kd_produk2, 'nama_produk' => $nama_produk2, 'rp_coret' => $rp_coret2, 'harga_jual' => $harga_jual2 );
        $produk3 = array('cetak_besar' => $cetak_besar, 'cetak_kecil' => $cetak_kecil, 'nm_satuan' => $nm_satuan3,'kd_produk' => $kd_produk3, 'nama_produk' => $nama_produk3, 'rp_coret' => $rp_coret3, 'harga_jual' => $harga_jual3 );
        $produk4 = array('cetak_besar' => $cetak_besar, 'cetak_kecil' => $cetak_kecil, 'nm_satuan' => $nm_satuan4,'kd_produk' => $kd_produk4, 'nama_produk' => $nama_produk4, 'rp_coret' => $rp_coret4, 'harga_jual' => $harga_jual4 );
        $produk5 = array('cetak_besar' => $cetak_besar, 'cetak_kecil' => $cetak_kecil, 'nm_satuan' => $nm_satuan5,'kd_produk' => $kd_produk5, 'nama_produk' => $nama_produk5, 'rp_coret' => $rp_coret5, 'harga_jual' => $harga_jual5 );
        $produk6 = array('cetak_besar' => $cetak_besar, 'cetak_kecil' => $cetak_kecil, 'nm_satuan' => $nm_satuan6,'kd_produk' => $kd_produk6, 'nama_produk' => $nama_produk6, 'rp_coret' => $rp_coret6, 'harga_jual' => $harga_jual6 );
        $produk7 = array('cetak_besar' => $cetak_besar, 'cetak_kecil' => $cetak_kecil, 'nm_satuan' => $nm_satuan7,'kd_produk' => $kd_produk7, 'nama_produk' => $nama_produk7, 'rp_coret' => $rp_coret7, 'harga_jual' => $harga_jual7 );
        $produk8 = array('cetak_besar' => $cetak_besar, 'cetak_kecil' => $cetak_kecil, 'nm_satuan' => $nm_satuan8,'kd_produk' => $kd_produk8, 'nama_produk' => $nama_produk8, 'rp_coret' => $rp_coret8, 'harga_jual' => $harga_jual8 );
