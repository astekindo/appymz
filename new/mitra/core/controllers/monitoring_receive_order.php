...
class Monitoring_receive_order extends MY_Controller {
	...
	public function get_data_ro($no_ro = ''){
		...
		$header = '
			<table width="600" border="0" cellspacing="1" cellpadding="5">
				...
				<tr>
					<td height="28" width="100" align="right" valign="middle" bgcolor="#ACD9EB"><b>Nama Supplier&nbsp;&nbsp;</b></td>
	...
	public function get_rows(){
        ...
        $result = $this->monitoring_ro_model->get_rows($kdSupplier, $tglAwal, $tglAkhir, $lokasi, $bloklokasi, $subbloklokasi, $search, $start, $limit);
