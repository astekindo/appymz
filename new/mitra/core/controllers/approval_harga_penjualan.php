...
class Approval_harga_penjualan extends MY_Controller {
	...
	public function approval(){
		...
		$result = $this->ahj_model->get_data_temp($no_bukti);
		...
		foreach($result as $data)
		{
			...
			// $produk_hj['rp_jual_distribusi'] = $data['rp_jual_distribusi'];
			
			//$produk_hj['hrg_beli_sup'] = $data['net_hrg_supplier_sup_inc'];
			$produk_hj['rp_ongkos_kirim'] = $data['rp_ongkos_kirim'];
			$produk_hj['pct_margin'] = $data['pct_margin'];
			$produk_hj['rp_margin'] = ($data['net_hrg_supplier_sup_inc'] * ($data['pct_margin']/100));
			$produk_hj['rp_jual_supermarket'] = $data['rp_jual_supermarket'];
			$produk_hj['rp_het_harga_beli'] = $data['rp_het_harga_beli'];
			$produk_hj['rp_het_cogs'] = $data['rp_het_cogs'];
			$produk_hj['koreksi_ke'] = $data['koreksi_produk'];
			...
			// unset($data['rp_het_harga_beli']);
			// unset($data['rp_het_cogs']);
			// unset($data['rp_cogs']);
			// unset($data['rp_ongkos_kirim']);
			// unset($data['pct_margin']);
			unset($data['status']);
			// unset($data['rp_jual_supermarket']);
			// unset($data['rp_jual_distribusi']);
			// unset($data['rp_het_harga_beli']);
