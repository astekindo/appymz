...
class Pembelian_create_po extends MY_Controller {
	/**
	 * @author dhamarsu
	 * @editedby luxse
    ...
    public function update_row(){
		...
		foreach($detail as $obj){
			...
			if($this->pcp_model->insert_row('purchase.t_purchase_detail', $detail_pr)){
	...
	public function get_ro_detail_by_supplier($kd_supplier = '', $wkt_top = '', $pkp = 1){
		...
		$detail = $this->pcp_model->get_ro_detail_by_supplier($kd_supplier, $wkt_top);
