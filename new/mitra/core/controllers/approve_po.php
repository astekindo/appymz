...
class Approve_po extends MY_Controller {
	...
	public function get_rows(){
        ...
        $result = $this->approve_po_model->get_rows($search, $start, $limit);
	...
	public function update_row(){
		...
		// exit;
		if($status == '9'){
			if ($this->approve_po_model->update_qty_po($qty_result->qty_po,$qty_result->no_ro)) {
