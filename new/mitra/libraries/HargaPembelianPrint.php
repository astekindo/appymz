...
class HargaPembelianPrint extends FormatLaporan {
	...
	public function privateData($d){
		...
		$detail .= '<tr>
						...
						<th align="center" width="130">Kode Barang<br>&<br>(Nama Supplier)</th>
						<th align="center" width="160">Nama Barang</th>
						<th align="center" width="45">Satuan</th>
						<th align="center" width="80">Harga Supplier</th>
						<th align="center" width="130">Disk Supermarket</th>
						<th align="center" width="90">Net Price Beli Sup (Inc)</th>
						<th align="center" width="90">Net Price Beli Sup (Exc)</th>
						<th align="center" width="120">Keterangan</th>
					</tr>	';
		if(!empty($d))
		{
			$no = 1;
			...
			foreach($d as $v)
			{
				...
				$detail .= '<tr>
								...
								<td align="center">'.number_format($v->hrg_supplier, 0,',','.').'</td>	
								<td align="center">'.$v->disk_supp1.'+'.$v->disk_supp2.'+'.$v->disk_supp3.'+'.$v->disk_supp4.'+'.$v->disk_amt_supp5.'</td>
								<td align="right">'.number_format($v->net_hrg_supplier_sup_inc, 0,',','.').'</td>
								<td align="right">'.number_format($v->net_hrg_supplier_sup, 0,',','.').'</td>
