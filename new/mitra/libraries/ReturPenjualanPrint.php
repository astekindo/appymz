...
class ReturPenjualanPrint extends FormatLaporan {
    ...
    public function privateData($h, $d) {
        ...
        $detail .= '<tr>
                        ...
                        <th align="center" width="90">Lokasi</th>
                        <th align="center" width="40">Qty SO</th>
                        <th align="center" width="40">Qty DO</th>
                    ...
                    // <th align="center" width="40">Qty SO</th>
                    // <td align="center">' . $v->qty_retur_so + $v->qty_retur_do . '</td>
        if (!empty($d)) {
            $no = 1;
            $sum_qty = 0;$sum_qty_so = 0;$sum_qty_do = 0;
            $sum_harga = 0;
            $sum_diskon = 0;
            $sum_diskon_ekstra = 0;
            $sum_total = 0;
...
//                $v->lokasi = "SL1-SL1-SL1";
                if($v->qty > 0){
                    $qty = $v->qty;
                }else if($v->qty_retur_so > 0){
                    $qty = $v->qty_retur_so;
                }else if($v->qty_retur_do > 0){
                    $qty = $v->qty_retur_do;
                } 
                $detail .= '<tr>
                    ...
                    <td align="center">' . $v->qty_retur_so . '</td>
                ...
                $no++;
                $sum_qty += $v->qty;
                $sum_qty_so += $v->qty_retur_so;
                $sum_qty_do += $v->qty_retur_do;
           ...
           $detail .= '<tr><td></td><td></td><td></td><td>Total : </td><td align="center">' . $sum_qty_so . '</td><td align="center">' . $sum_qty_do . '</td><td align="center">' . $sum_qty . '</td><td></td><td align="right"></td><td align="center"></td><td align="center"></td><td align="right">' .number_format($sum_total,0,',','.') . '</td></tr>';
