			...
			<tr>
				...
				<table cellspacing="1" style="text-align:left" >
					<tr style="font-size: 1.0em">
						<td width="85">'.$no_po.'</td>
						<td width="10"> : </td>
						<td width="270">'.$h->no_po.'</td>
                                                <td width="120">No PO Induk</td>   
						<td >: '.$h->no_po_induk.$this->write1DBarcode($h->no_po, 'C39', '', '', '', 10, 0.2, $style, 'N').'</td>
					</tr>    
					<tr style="font-size: 1.0em">
						<td>Tanggal PO</td>
						<td> : </td>
					...
					<tr style="font-size: 1.0em">
						<td>Alamat</td>
						<td> : </td>
						<td width="80%">'.$h->alamat_kirim_po.'</td>
					</tr>
					<tr>
						<td colspan="2">&nbsp;</td>
					</tr>
