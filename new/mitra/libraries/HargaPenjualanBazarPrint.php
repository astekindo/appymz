...
class HargaPenjualanBazarPrint extends FormatLaporan {
	...
	public function privateData($d){
		...
		$detail .= '<tr>
						...
						<th align="center" width="90">Hrg Jual Bazar</th>
						<th align="center" width="135">Disk Bazar / Net Price Jual Bazar</th>	
		...
		if(!empty($d))
		{
			...
			foreach($d as $v)
			{
				...
				$detail .= '<tr>
											...
											<td align="center">'.number_format($v->rp_jual_bazar, 0,',','.').'</td>
											
											<td align="center">('.number_format($hrg_kons,0,',','.').') / '. number_format($v->rp_jual_bazar_net, 0,',','.') .'</td>
