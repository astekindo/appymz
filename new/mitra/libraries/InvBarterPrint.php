...
class InvBarterPrint extends FormatLaporan {
            ...
            <tr>
                ...
                <table border= "0" cellspacing="0" style="text-align:left" width="100%">
                    ...
                    <tr >
                        ...
                        <td width="240"> : ' . $h->pic_penerima . '</td>
                        <td width="110">No SB</td>
                        <td width="240">: ' . $h->no_sb . '</td>
                        <td width="110">Tgl SB</td>
                        <td width="240">: ' . $h->tanggal . '</td>
                    </tr>    
                    <tr >
                        <td>Alamat</td>
                        <td> : ' . $h->alamat_penerima . '</td>
                        <td >No Transfer</td>
                        <td >: ' . $h->no_transfer_stok . '</td>
                        <td >No PO</td>    
                        <td >: ' . $no_po  . '</td>
                    </tr>
                    <tr >
