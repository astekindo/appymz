...
class LaporanPenjualanPerSjPrint extends FormatLaporan {
        ...
        if (!empty($d)) {
            ...
            foreach ($d as $v) {
                $detail .= '<tr>
                                ...
                                <td align="center" width="70">' . $v->nama_member . '</td>
                                <td align="center" width="70">' . $v->kd_produk . '</td>
                                <td align="center" width="80">' . $v->nama_produk . '</td>
                                <td align="center" width="70">' . $v->qty_so . '</td>
                                <td align="center" width="60">' . $v->qty_kirim . '</td>
                                <td align="center" width="60">' . $v->qty_sisa . '</td>
                                <td align="center" width="70">' . $v->tag_awal . '</td>
                                <td align="center" width="70">' . $v->tag_update . '</td>
                                <td align="center" width="70">' . $v->nilai_sisa . '</td>
                                <td align="center" width="70">' . $v->gantung . '</td>
			...
			<tr>
				...
				<table border= "0" cellspacing="0" style="text-align:left" width="100%" >                                        
					<tr style="font-size:14:">
                                        <td width="210">Laporan Penjualan Per Surat Jalan</td>                                        
					</tr>  
