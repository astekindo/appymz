...
class PembayaranPiutangDistribusiPrint extends FormatLaporan {
	...
	$this->AddPage();
		...
		$detail .= '<tr>
						...
						<th align="center" width="130">No Faktur</th>
                                                <th align="center" width="130">Tgl Faktur</th>
						<th align="center" width="100">Rp Faktur</th>
                                                <th align="center" width="150">Rp Potongan</th>
                                                <th align="center" width="100">Rp Dibayar</th>
                                                <th align="center" width="100">Total Bayar</th>
						<th align="center" width="100">Rp Kurang Bayar</th>					
					</tr>	';
		if(!empty($d))
		{
			$no = 1;
			...
			foreach($d as $v)
			{
				...
				$detail .= '<tr>
								...
								<td align="right">'.number_format($v->rp_dibayar, 0,',','.').'</td>
                                                                <td align="right">'.number_format($v->total_bayar, 0,',','.').'</td>
								<td align="right">'.number_format($v->rp_kurang_bayar, 0,',','.').'</td>
								</tr>	';			
							$no++;
                                                        $jumlah_dibayar = $jumlah_dibayar + $v->rp_dibayar;
			}
			$detail .= '<tr><td></td><td></td><td></td><td></td><td align="right">Total Jumlah Dibayar</td><td align="right">'.number_format($jumlah_dibayar, 0,',','.').'</td><td></td><td></td></tr>';
		}
		else
		{
			$detail .= '<tr><td>-----</td></tr>';			
		...
		<table width="100%" border="0" cellspacing="10" cellpadding="0">
			...
			<tr>
				...
				<table cellspacing="1" style="text-align:left">
						...
						<td width="580">: '.$h->no_pembayaran_piutang.'</td>
