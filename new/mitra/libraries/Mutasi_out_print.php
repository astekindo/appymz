...
class Mutasi_out_print extends FormatLaporan {
...
<table width="100%" border="1" cellspacing="0" cellpadding="2">
    <tr>
        ...
        <th align="center" width="180">Lokasi Asal</th>
        <th align="center" width="80">Lokasi Tujuan</th>
    </tr>
EOT;
    if (!empty($d)) {
        $no = 1;
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
    <tr>
        ...
        <td align="center" width="225">Dikeluarkan</td>
