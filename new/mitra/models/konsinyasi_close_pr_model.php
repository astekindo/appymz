...
class konsinyasi_close_pr_model extends MY_Model {
    ...
    public function get_rows($kd_supplier = "", $search = "",$start,$limit) {
        ...
        /*
        select no_ro, tgl_ro, subject, waktu_top, keterangan1, keterangan2 from purchase.t_purchase_request where close_ro = 0 and konsinyasi = '0' and status = '2' and kd_supplier = '01A001'
        */
        $this->db
