...
class Pembelian_receive_order_bonus_model extends MY_Model {
	 ...
	 * @lastedited 2 jan 2012
	 */
	public function get_all_po($kd_supplier = "",$no_po_induk =""){
		if($no_po_induk != ""){
                    $this->db->where("no_po_induk", $no_po_induk);
                }else if ($no_po_induk == ""){
                    $this->db->where("no_po_induk","");
                }
                $this->db->select("*");
