 ...
 * @author Yakub
 */
class cetak_delivery_order_model extends MY_Model {
    ...
    public function getDataDeliveryOrder($limit, $offset, $search = "", $tglAwal = "", $tglAkhir = "") {
        $result = '';
        $total = 0;
        $sqlFilter = '';
        $sqlSearch = '';
        ...
        $mainQuery = 'SELECT * FROM sales.t_sales_delivery_order a';
    ...
    public function getDataDeliveryOrderDetail($limit, $offset, $noDO, $search = '') {
        $result = '';
        $total = 0;
        $sqlSearch = '';
        if (!empty($search)) {
        ...
        $queryData = "SELECT a.*,b.nama_produk FROM "
                . "sales.t_sales_delivery_order_detail a "
        ...
        $queryTotal = "SELECT COUNT(*) AS total FROM"
                ...
                . "sales.t_sales_delivery_order_detail a LEFT JOIN"
