 ...
 * @author Yakub
 */
class cetak_surat_jalan_model extends MY_Model {
    ...
    public function getDataSuratJalan($limit, $offset, $search = "", $tglAwal = "", $tglAkhir = "") {
        $result = '';
        $total = 0;
        $sqlFilter = '';
        $sqlSearch = '';
        ...
        $mainQuery = 'SELECT * FROM sales.t_surat_jalan a';
    ...
    public function getDataSuratJalanDetail($limit, $offset, $noSJ, $search = '') {
        $result = '';
        $total = 0;
        $sqlSearch = '';
        if (!empty($search)) {
        ...
        $queryTotal = "SELECT COUNT(*) AS total FROM"
                ...
                . "sales.t_surat_jalan_detail a LEFT JOIN"
