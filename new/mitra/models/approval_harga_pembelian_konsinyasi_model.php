...
class Approval_harga_pembelian_konsinyasi_model extends MY_Model {
	...
	public function get_data_temp($no_bukti = ""){
        ...
        public function get_data_inventory($kd_produk = ""){
		$sql ="select a.*,b.*,c.pkp
                       from inv.t_brg_inventory a
                       left join mst.t_supp_per_brg b on a.kd_produk = b.kd_produk
                       left join mst.t_supplier c on c.kd_supplier = b.kd_supplier
	...
	public function cek_exists_brg_inv($kd_produk = null, $kd_lokasi = null, $kd_blok = null, $kd_sub_blok = null) {
        ...
        public function get_data_harga_jual($kd_produk="",$tgl_start_diskon=""){
		...
		return $result;
         ...
         public function get_qty($kd_produk = ""){
		$sql ="select kd_produk,sum(qty_oh)qty from inv.t_brg_inventory
                        where kd_produk = '$kd_produk' group by kd_produk ";
		...
		$sql ="select * from mst.t_supplier
    ...
    public function update_diskon_jual_konsinyasi($kd_produk = NULL,$tgl_start_diskon="",$data = NULL){
        $this->db->where('kd_produk',$kd_produk);
        $this->db->where('tgl_start_diskon', $tgl_start_diskon);
    ...
    public function is_auto_update_hj($kd_supplier)
    {
    	$result = $this->db->get_where('mst.t_supplier', array('kd_supplier' => $kd_supplier));
