...
class Konsinyasi_create_request_model extends MY_Model {
	...
	public function search_produk_by_supplier($kd_supplier = '', $sender = "", $search = "", $offset, $length){
		...
		$sql = "SELECT 
				...
				JOIN 
					...
					AND is_konsinyasi = '1' ".$sql_search." 
  				JOIN 
				...
				GROUP BY 
					s.waktu_top,a.nama_produk, a.kd_produk, a.min_stok, a.max_stok, b.nm_satuan,a.kd_produk_supp,a.kd_produk_lama, a.min_stok, a.max_stok, a.min_order,a.is_kelipatan_order
				ORDER BY 
					a.nama_produk ASC";
