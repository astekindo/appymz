...
class Setting_target_jual_model extends MY_Model {
	...
	public function insert_row($data = NULL){
		return $this->db->insert('mst.t_setting_target_jual',$data);
	}	
        ...
        public function update_row($updated_data = NULL, $bulan = '',$tahun = '', $kd_kategori1 = '', $kd_kategori2 = '', $kd_kategori3 = '',$kd_kategori4 = ''){
            ...
            $return = $this->db->update('mst.t_setting_target_jual',$updated_data);
	...
	public function get_row($bulan = '',$tahun = '', $kd_kategori1 = '', $kd_kategori2 = '', $kd_kategori3 = '',$kd_kategori4 = ''){
		...
		$this->db->where("bulan",$bulan);
                $this->db->where("tahun",$tahun);
		$query = $this->db->get("mst.t_setting_target_jual");
...
//        }
        ...
        $sql = "select a.nama_kategori1,a.kd_kategori1,b.nama_kategori2,b.kd_kategori2,c.nama_kategori3,c.kd_kategori3,d.nama_kategori4,d.kd_kategori4,e.target_qty,e.target_rupiah
                ...
                left join (select * from mst.t_setting_target_jual where bulan = '$bulan' and tahun = '$tahun') e on e.kd_kategori1 = a.kd_kategori1 and e.kd_kategori2 = b.kd_kategori2 and e.kd_kategori3 = c.kd_kategori3 and e.kd_kategori4 = d.kd_kategori4
                where 1=1 $where";
