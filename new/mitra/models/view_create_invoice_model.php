...
class View_create_invoice_model extends MY_Model {
    ...
    public function search_noinvoice($kd_peruntukan ="", $search = "", $offset, $length) {
        ...
        $sql1 = "select no_invoice,tgl_invoice from purchase.t_invoice where 1=1 " . $sql_search . " order by tgl_invoice desc 
