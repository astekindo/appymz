...
class View_pelunasan_hutang_model extends MY_Model {
    ...
    public function search_nobukti($kd_peruntukan ="",$search = "", $offset, $length) {
        ...
        $sql1 = "select no_bukti,tanggal from purchase.t_pelunasan_hutang where 1=1 " . $sql_search . " ".$peruntukan." order by tanggal desc 
